...
public class InformacionLaboralResource {
    ...
    @GetMapping("/informacion-laborals/filtroByPersona")
   	public List<InformacionLaboral> getByPersona(@RequestParam("persona") String persona) {
   		return informacionLaboralService.getByPersona(Long.parseLong(persona));
   	}
}
